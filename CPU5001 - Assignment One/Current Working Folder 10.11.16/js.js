...
function randomNumber() { //function to generate the random numbers used within the game
    ...
    while (randomNum.length < 90) { //while condition to loop to generate 90 unique numbers. 
        ...
        ranNum = (Math.floor(Math.random() * 90 + 1)); //variable is passed a built in method which generates a random number using math.random. math.floor is used to generate a whole number. 
        var found = false;
