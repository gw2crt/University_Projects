...
<body>
        ...
        <div class="container">
            <div class="alert alert-info" role="alert"> <strong>Add News Story</strong></div>
            <div class="row">
                <div class="col-sm-8">
                    <form method="post" name="addstory" action="add_n.php" novalidate="">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="a_name" id="name" placeholder="Your Name *" required="" data-validation-required-message="Please enter your name.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Your Email *" name="a_email" id="email" required="" data-validation-required-message="Please enter your email address.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Your Headline *" name="a_headline" id="headline" required="" data-validation-required-message="Please enter your Headline">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Your News Story*" name="a_story" id="newsstory" required="" data-validation-required-message="Please enter a news story."></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
