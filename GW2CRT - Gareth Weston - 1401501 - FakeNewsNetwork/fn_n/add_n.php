...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $name = validate($_POST["a_name"]);
  $email = validate($_POST["a_email"]);
  $headline = validate($_POST["a_headline"]);
  $story = validate($_POST["a_story"]);
}
...
$sql = "INSERT INTO fakenews (headline, story, name, email )
            VALUES ('$headline', '$story', '$name', '$email')";
...
?>
        ...
        <div class="container text-center">
        <h1>Thanks your News Story has been created. </h1> 
        </div>
